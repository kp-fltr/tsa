import svgPaths from "./svg-9hvs4asuxn";
    ...
    >
      ...
      >
        <g id="Checkbox/Inactive/Default">
          <g id="Plate">
            <mask fill="white" id="path-2-inside-1_2013_26566">
              <path d={svgPaths.p1d1d6d00} />
            </mask>
            <path d={svgPaths.p1d1d6d00} fill="var(--fill-0, white)" />
            <path
              d={svgPaths.p3ab9ab80}
              fill="var(--stroke-0, #D4D4D8)"
              mask="url(#path-2-inside-1_2013_26566)"
            />
          </g>
        </g>
      </svg>
...
function Table1() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col items-end justify-start left-[71px] p-0 top-[67px] w-[1136px]"
      data-name="Table"
    >
      <Table />
      <Pagination />
